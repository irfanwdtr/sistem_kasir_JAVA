    ...
    private void simpan_transaksi()
{
    try{
        ...
        for(int i=0;i<tblBrg.getRowCount();i++)
        {
            ...
            int xpjk=(Integer)tblBrg.getValueAt(i,4);
//           ----------------------------------------------------------pajak
...
//
//    // Menghitung pajak
//    xpajak = (int) (xtotal * 0.1);
//    xkembali = xbayar - (xtotal + xpajak);
//
//    // Menampilkan jumlah pajak
//    String xpajakxx = Integer.toString(xpajak);
//    txtpajak.setText(xpajakxx);
//
//    String xkembalixx = Double.toString(xkembali);
//    txtKembali.setText(xkembalixx);
//}
...
//        double xpajak=(Double)tblBrg.getValueAt(i,5);
